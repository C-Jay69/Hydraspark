...
```bash
git remote add encore encore://hydraspark-social-safety-tpci
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/hydraspark-social-safety-tpci/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/hydraspark-social-safety-tpci/settings/integrations/github)
